...
describe('#remove', function() {
  ...
  before(function(done) {
    mkdirp(testDir + '/s0/s1', function(err) {
      ...
      fs.writeFile(
        testDir + '/s0/s1/bitcore-node-square.json',
  ...
  describe('will modify scaffold files', function() {
    ...
    it('will update bitcore-node-square.json services', function(done) {
      ...
      removetest({
        ...
        var configPath = path.resolve(testDir, 's0/s1/bitcore-node-square.json');
