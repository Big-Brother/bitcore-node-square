...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-square a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-square create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-square add wallet-service');
      console.log('    $ bitcore-node-square add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-square remove wallet-service');
      console.log('    $ bitcore-node-square remove insight-api');
      console.log();
    });
