...
/**
 * Will return the path and default bitcore-node-square configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-square.json');
